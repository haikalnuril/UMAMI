            ...
            <section class="hero bg-cover bg-center h-screen text-white" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="container font-[Poppins] mx-auto h-full flex justify-around items-center">
                    <div class=" px-20 flex flex-col">
                        ...
                        <p class="text-lg mb-4 w-[600px] text-black">Resep adalah perpaduan antara sains dan seni, di mana takaran sempurna bertemu dengan kreativitas.</p>
                        <a href="<?= urlpath('dashboard-writer/show') ?>" class="bg-[#FF7D29] px-5 py-2 rounded-2xl text-white w-40 text-center ">Resep Kamu</a>
                    </div>
                    <div>
